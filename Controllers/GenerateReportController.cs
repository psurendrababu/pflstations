...
namespace PipelineFeatureList.Controllers
{
    public class GenerateReportController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                ViewBag.PipeSystemData = new SelectList(db.PipeSystems, "PipeSystemID", "PipeSystemItem");
                ViewBag.PipelineData = new SelectList(db.Pipelines, "PipelineID", "PipelineItem");

                GenerateReport gr = new GenerateReport();
                gr.PipeSystemData = new SelectList(db.PipeSystems, "PipeSystemID", "PipeSystemItem");
                gr.PipelineData = new SelectList(db.Pipelines, "PipelineID", "PipelineItem");

                //var modelANR = db.CertificationApproveds.Include("ValveSection")
                //                    .Include("PipeSystems")
                //                    .Include("Pipelines")
                //                    .Include("ValveSectionStatus")
                //                    .Where(v => v.PipeSystem.PipeSystemItem == "ANR")
                //                    .Where(v => v.ValveSectionStatus.ValveSectionStatusItem == "Certification Approved")
                //                    .OrderBy(v => v.OrionStationSeries).ToList();
                //ViewData.Add("ANRValveSectionsData", modelANR);
                //var modelGLGT = db.ValveSection.Include("CertificationApproveds")
                //                    .Include("PipeSystems")
                //                    .Include("Pipelines")
                //                    .Include("ValveSectionStatus")
                //                    .Where(v => v.PipeSystem.PipeSystemItem == "GLGT")
                //                    .Where(v => v.ValveSectionStatus.ValveSectionStatusItem == "Certification Approved")
                //                    .OrderBy(v => v.OrionStationSeries).ToList();
                //ViewData.Add("GLGTValveSectionsData", modelGLGT);
                //var modelGTN = db.ValveSection.Include("CertificationApproveds")
                //                                    .Include("PipeSystems")
                //                                    .Include("Pipelines")
                //                                    .Include("ValveSectionStatus")
                //                                    .Where(v => v.PipeSystem.PipeSystemItem == "GTN")
                //                                    .Where(v => v.ValveSectionStatus.ValveSectionStatusItem == "Certification Approved")
                //                                    .OrderBy(v => v.OrionStationSeries).ToList();
                //ViewData.Add("GTNValveSectionsData", modelGTN);
                //var modelNB = db.ValveSection.Include("CertificationApproveds")
                //                                    .Include("PipeSystems")
                //                                    .Include("Pipelines")
                //                                    .Include("ValveSectionStatus")
                //                                    .Where(v => v.PipeSystem.PipeSystemItem == "NB")
                //                                    .Where(v => v.ValveSectionStatus.ValveSectionStatusItem == "Certification Approved")
                //                                    .OrderBy(v => v.OrionStationSeries).ToList();
                //ViewData.Add("NBValveSectionsData", modelNB);


                //var modelANR = (from v in db.ValveSection
                //                       join ps in db.PipeSystems on v.PipeSystemID equals ps.PipeSystemID into ps1
                //                       from psd in ps1.DefaultIfEmpty()
                //                       join pl in db.Pipelines on v.PipelineID equals pl.PipelineID into pl1
                //                       from pld in pl1.DefaultIfEmpty()
                ...
                //                       join ca in db.CertificationApproveds on v.ValveSectionID equals ca.ValveSectionID into ca1
                //                       from cad in ca1.DefaultIfEmpty()
                //                       where vssd.ValveSectionStatusItem == "Certification Approved"
                //                       && psd.PipeSystemItem == "ANR"
                //                       orderby v.OrionStationSeries
                //                       select new ANRValveSections
                //                        { ValveSectionID = v.ValveSectionID,
                //                         PipeSystem = psd.PipeSystemItem,
                //                         Pipeline = pld.PipelineItem,
                //                         OrionStationSeries = v.OrionStationSeries,
                //                         Status = cad.Status 
                //                       }).ToList();
                //ViewBag.ANRValveSectionsData = modelANR;
                //var modelGLGT = (from v in db.ValveSection
                //             join ps in db.PipeSystems on v.PipeSystemID equals ps.PipeSystemID into ps1
                //             from psd in ps1.DefaultIfEmpty()
                //             join pl in db.Pipelines on v.PipelineID equals pl.PipelineID into pl1
                //             from pld in pl1.DefaultIfEmpty()
                ...
                //             from cad in ca1.DefaultIfEmpty()
                //             where vssd.ValveSectionStatusItem == "Certification Approved"
                //             && psd.PipeSystemItem == "GLGT"
                //             orderby v.OrionStationSeries
                //             select new GLGTValveSections
                //             {
                //                 ValveSectionID = v.ValveSectionID,
                //                 PipeSystem = psd.PipeSystemItem,
                //                 Pipeline = pld.PipelineItem,
                ...
                //                 Status = cad.Status
                //             }).ToList();
                //ViewBag.GLGTValveSectionsData = modelGLGT;
                //var modelGTN = (from v in db.ValveSection
                //             join ps in db.PipeSystems on v.PipeSystemID equals ps.PipeSystemID into ps1
                //             from psd in ps1.DefaultIfEmpty()
                //             join pl in db.Pipelines on v.PipelineID equals pl.PipelineID into pl1
                //             from pld in pl1.DefaultIfEmpty()
                ...
                //             from cad in ca1.DefaultIfEmpty()
                //             where vssd.ValveSectionStatusItem == "Certification Approved"
                //             && psd.PipeSystemItem == "GTN"
                //             orderby v.OrionStationSeries
                //             select new GTNValveSections
                //             {
                //                 ValveSectionID = v.ValveSectionID,
                //                 PipeSystem = psd.PipeSystemItem,
                //                 Pipeline = pld.PipelineItem,
                ...
                //                 Status = cad.Status
                //             }).ToList();
                //ViewBag.GTNValveSectionsData = modelGTN;
                //var modelNB = (from v in db.ValveSection
                //             join ps in db.PipeSystems on v.PipeSystemID equals ps.PipeSystemID into ps1
                //             from psd in ps1.DefaultIfEmpty()
                //             join pl in db.Pipelines on v.PipelineID equals pl.PipelineID into pl1
                //             from pld in pl1.DefaultIfEmpty()
                ...
                //             from cad in ca1.DefaultIfEmpty()
                //             where vssd.ValveSectionStatusItem == "Certification Approved"
                //             && psd.PipeSystemItem == "NB"
                //             orderby v.OrionStationSeries
                //             select new NBValveSections
                //             {
                //                 ValveSectionID = v.ValveSectionID,
                //                 PipeSystem = psd.PipeSystemItem,
                //                 Pipeline = pld.PipelineItem,
                ...
                //                 Status = cad.Status
                //             }).ToList();
                //ViewBag.NBValveSectionsData = modelNB;
        ...
        public List<ValveSectionQCAssigned> QCAssigned()
        {
            ...
            List<ValveSectionQCAssigned> model = (from v in db.ValveSection
                         join vss in db.ValveSectionStatus on v.ValveSectionStatusID equals vss.ValveSectionStatusID into vss1
                         from vssd in vss1.DefaultIfEmpty()
                         join dg in db.DisplayGroups on vssd.DisplayGroupID equals dg.DisplayGroupID into dg1
                         from dgd in dg1.DefaultIfEmpty()
        ...
        public ActionResult StatusChange(ValveSection ValveSection)
        {
            if (ModelState.IsValid)
            {
                ...
                var newStatusActions = (from v in db.ValveSectionStatus
                                        ...
                                        select new { v.AssignBuilder, v.AssignQC, v.AssignEngineer, v.AssignFinalEngineer, v.AssignAnnualReviewer, v.CopyDataToHistory, v.GenerateGrades, v.QueueCertification, v.DynamicSegmentation, v.RedirectAction }).FirstOrDefault();
                ...
                //PH 2014.05.22 need user id here
        ...
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.Parameters.Add(new SqlParameter("@ValveSectionID", valvesection.ValveSectionID));
        //    cmd.Parameters.Add(new SqlParameter("@Database", dbName));
